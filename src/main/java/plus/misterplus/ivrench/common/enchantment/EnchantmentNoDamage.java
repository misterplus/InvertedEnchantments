...
public class EnchantmentNoDamage extends Enchantment {
    ...
    public EnchantmentNoDamage(Enchantment.Rarity rarityIn, int damageTypeIn, EntityEquipmentSlot... slots)
    {
    ...
    {
        return !(ench instanceof EnchantmentDamage || ench instanceof EnchantmentNoDamage);
    }
    ...
    public void onEntityDamaged(EntityLivingBase user, Entity target, int level)
    {
        if (target instanceof EntityLivingBase)
        {
            ...
            if (this.damageType == 2 && entitylivingbase.getCreatureAttribute() == EnumCreatureAttribute.ARTHROPOD)
            {
                ...
                entitylivingbase.addPotionEffect(new PotionEffect(MobEffects.SPEED, i, 3));
            }
        }
    }
}
