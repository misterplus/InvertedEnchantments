...
public class RegistryEventHandler {
    ...
    public static void onEnchantmentRegistration(final RegistryEvent.Register<Enchantment> event) {
        ...
        event.getRegistry().registerAll(new WaterSlowerEnchantment(RARE, aEquipmentSlotType).setFakeName("waterWorker").setName("aqua_allergy").setRegistryName("aqua_allergy"));
        ...
        event.getRegistry().registerAll(new WaterTrapperEnchantment(RARE, aEquipmentSlotType).setFakeName("waterWalker").setName("depth_slower").setRegistryName("depth_slower"));
        event.getRegistry().registerAll(new IceMelterEnchantment(RARE, FEET).setFakeName("frostWalker").setName("ice_melter").setRegistryName("ice_melter"));
        ...
        event.getRegistry().registerAll(new SelfFireEnchantment(RARE, MAINHAND).setFakeName("fire").setName("self_fire").setRegistryName("self_fire"));
        event.getRegistry().registerAll(new LootlessEnchantment(RARE, WEAPON, MAINHAND).setFakeName("lootBonus").setName("lootLess").setRegistryName("loot_less"));
        event.getRegistry().registerAll(new LootlessEnchantment(RARE, DIGGER, MAINHAND).setFakeName("lootBonusDigger").setName("lootLessDigger").setRegistryName("loot_less_digger"));
        event.getRegistry().registerAll(new LootlessEnchantment(RARE, FISHING_ROD, MAINHAND).setFakeName("lootBonusFishing").setName("lootLessFishing").setRegistryName("loot_less_fishing"));
